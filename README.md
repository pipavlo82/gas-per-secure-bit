...
| Scheme        | Bench name                                | gas_verify  | lambda_eff | gas / secure-bit |
|---------------|-------------------------------------------|------------:|----------:|-----------------:|
...
| **ML-DSA-65** | preA_compute_w_fromPackedA_ntt_rho0_log   | 1,499,354   | 128       | 11,713.703       |
| **ML-DSA-65** | preA_compute_w_fromPackedA_ntt_rho1_log   | 1,499,354   | 128       | 11,713.703       |
...
| **ML-DSA-65** | verify_poc_foundry                        | 68,901,612  | 128       | 538,293.844      |
